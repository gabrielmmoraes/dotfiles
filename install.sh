...
yay -S git firefox google-chrome discord pulseaudio pavucontrol \
    ...
    zsh-syntax-highlighting optimus-manager linux54-bbswitch betterlockscreen
...
sudo ln ~/git/dotfiles/optimus-manager/optimus-manager.conf /etc/optimus-manager/optimus-manager.conf
